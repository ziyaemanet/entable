...
export default class BankDetail6 extends Component {
  constructor() {
    super();
    this.state = {
  ...
  render() {
    ...
    let currBank = banks.filter(bank => bank.name === 'bank5');
      ...
      <div>
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-6 imgContainer">
              <div className="groupImg">
                <img className="bankDetialImg" src={dummy[4].Images[0]}/>
              </div>
            </div>
          ...
          <div className="groupDonateBtn">
            <button onClick={() => browserHistory.push('/donation6')} className="donateBtn">Add Funds to This Bank</button>
          </div>
