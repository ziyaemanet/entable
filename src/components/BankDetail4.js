...
export default class BankDetail4 extends Component {
  constructor() {
    super();
    this.state = {
  ...
  render() {
    ...
    let currBank = banks.filter(bank => bank.name === 'bank3');
      ...
      <div>
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-6 imgContainer">
              <div className="groupImg">
                <img className="bankDetialImg" src={dummy[2].Images[0]}/>
              </div>
            </div>
            <div className="col-md-6 groupInfo">
              <div className='groupDesc'>
                ...
                <div className="groupDesc">
                  <h4>{dummy[2].Name} Details and Information: </h4>
                  <p>{dummy[2].Description1}</p>
                  <p>{dummy[2].Description2}</p>
                  <p>{dummy[2].Description3}</p>
                </div>
          ...
          <div className="groupDonateBtn">
            <button onClick={() => browserHistory.push('/donation4')} className="donateBtn">Add Funds to This Bank</button>
          </div>
